...
fulcrum_csv_data=pd.read_csv("prueba_uat_hw_decodificadores.csv")
...
uat_date_rev = 3
fijos = 8
limite_superior_fij = limite_inferior_fij + uat_date_rev + fijos
#*******************************************************************
#n2 = int(input('NÚMERO DE PRUEBAS FUNCIONALES: '))
#pruebas_funcionales = int(n2*2)
pruebas_funcionales = 12 #ES EL NÚMERO DE PRUEBASx2
fotos_pruebas = 1
#*******************************************************************
suma = campos_fulcrum + uat_date_rev + fijos
...
with open('fijos_uat.csv', 'w') as csvfile:
...
#*******************************************************************
inicio_num_datos_pruebas_fun = 19
#*******************************************************************
...
for index, row in fulcrum_csv_data.iterrows():
	...
	#*******************************************************************
	#Paths imágenes
	path_photos = r'/Users/jmpas/Desktop/uat/photos_uat_decos/'
	path_firmas = r'/Users/jmpas/Desktop/uat/firmas/'
	#*******************************************************************
	...
	#Genera y guarda PDF
	filename='ATC_UAT_DEC_%s.pdf'%(fulcrum_csv_data[fulcrum_csv_data.columns[5]].iloc[index])
